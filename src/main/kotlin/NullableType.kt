 ...
 */
fun main() {
    NullableType.nullableDeclaration()
    NullableType.safeCallOperator()
    NullableType.elvisOperator()
    NullableType.safeCasting()
    NullableType.nullableCollections()
    NullableType.nullableMap()
    NullableType.nullableControlFlow()
}